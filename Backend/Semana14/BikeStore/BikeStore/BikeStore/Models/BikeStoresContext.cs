...
{
    public partial class BikeStoresContext : IdentityDbContext
    {
        ...
        // Unable to generate entity type for table 'production.product_history'. Please see the warning messages.
